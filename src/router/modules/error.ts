...
const error_page: RouteConfig = {
    ...
    children: [
        {
            path: '401',
            component: () => import('@/views/error_page/401_page/index.vue'),
            name: 'errorPage401',
            ...
            children: [
                {
                    ...
                    component: () =>
                        import(
                            /* webpackChunkName: "errorPage" */ '@/views/error_page/4011_page/index.vue'
                        ),
                    name: 'errorPage4011',
        ...
        },
        {
            path: '404',
            component: () =>
                import(/* webpackChunkName: "errorPage" */ '@/views/error_page/404_page/index.vue'),
            name: 'errorPage404',
