<template>
  <div class="panel-tab__content">
    <el-form :model="elementBaseInfo" size="mini" label-width="90px" @submit.native.prevent>
      ...
      <el-form-item label="所属平台" prop="tenantId">
        <el-select v-model="elementBaseInfo.tenantId" @change="val=>updateBaseInfo('tenantId',val)">
          <el-option
      ...
      <el-form-item label="流程分类" prop="processCategory">
        <treeselect :normalizer="normalizer" @change="val=>updateBaseInfo('processCategory',val)" v-model="elementBaseInfo.processCategory" :options="ProcessCategoryDict" placeholder="选择流程分类" />
      </el-form-item>
      <!--流程的基础属性-->
      ...
      <el-form-item prop="isExpanded" v-if="elementBaseInfo.$type === 'bpmn:SubProcess'" label="状态">
