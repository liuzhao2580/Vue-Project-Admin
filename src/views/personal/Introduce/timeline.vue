			...
			activities: [
				{
                    ...
                    icon: "el-icon-more",
                    project_outline: "项目概述：展示公司的基本信息，提供注册登录选项，对公司的产品进行展示.",
                    project_personal: "个人职责：主要负责首页、注册、登录等页面的布局，其他页面简单动画的切换，用户的交互功能"
				},
				{
					project_name: "多赢普惠APP",
                    timestamp: "201801-201807",
                    icon: "el-icon-view",
                    project_outline: "项目概述：用户可以进行登录、注册、查询等功能，每日基金推荐、提供网贷服务等功能.",
				...
				},
				{
                    ...
                    icon: "el-icon-bell",
                    project_outline: "项目概述：类似于京东淘宝的购物商城，用户可以进行注册、登录、搜索商品、购物等基本功能",
                    project_personal: "个人职责： 整个项目自己主要负责商城注册页面、登录页面和购物车页面以及一些其它页面的编写和渲染，通过发送Ajax向后台请求数据，校验用户登录名和密码是否匹配等等功能的实现"
				},
				{
                    ...
                    project_personal: "个人职责:  整个项目基本上是自己独立完成, 在任务比较繁重的时候, 后台的工作人员会帮忙完善一些功能代码."
				}
			]
		};
	},
