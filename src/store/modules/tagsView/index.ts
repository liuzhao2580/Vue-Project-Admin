...
const mutations = {
  [TAGS_VIEW_MUTATIONS_TYPES.MUT_INIT_TAGS](state: StoreTagsViewModel, tags: ITagsView[]) {
    state.tagsArray = tags
  },
  [TAGS_VIEW_MUTATIONS_TYPES.MUT_INSERT_TAGS](state: { tagsArray: ITagsView[] }, tags: ITagsView) {
